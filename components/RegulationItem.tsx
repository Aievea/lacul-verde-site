...
const RegulationItem = ({ icon, title, desc }: RegulationItemProps) => (
  <div className="flex flex-col items-center text-center gap-3 p-6 rounded-2xl bg-surface border border-outline-variant/30 hover:shadow-md hover:-translate-y-1 transition-all duration-200 h-full">
